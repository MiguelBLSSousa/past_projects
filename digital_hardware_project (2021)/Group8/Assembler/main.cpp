...
string parts2Bin(string &op, string &rs1, string &rs2){
        ...
        if (op.compare("LOAD")== 0) {
            ...
            else if(rs1.compare("N") == 0){
                MachineCode = MachineCode + "01";

            }
            else if(rs1.compare("V") == 0){
                MachineCode = MachineCode + "10";

            }
            else if(rs1.compare("C") == 0){
...
int main()
{
    ...
    inFile.open("C:\\Users\\matth\\Documents\\module 5\\Project\\assembler\\source.txt");
    outFile.open("C:\\Users\\matth\\Documents\\module 5\\Project\\assembler\\target.txt");
    if (!inFile) {
